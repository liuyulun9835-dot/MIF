...
{
    /// <summary>
    /// MIF ATAS导出器 V18 - 精准Cluster读取 + DOM历史支持 + 导出节流
    ///
    /// V18关键更新：
    ...
    /// - 固定维度 - 保证数据维度一致性
    /// </summary>
    [DisplayName("MIF Exporter V18")]
    public class MifExporterV18 : Indicator
    {
        #region 配置参数
        ...
        public MifExporterV18()
        {
            Name = "MIF Exporter V18";
            ...
            try
            {
                ...
                if (_alivePath != null)
                {
                    ...
                    File.AppendAllText(_alivePath,
                        ...
                        $"V18 Features: Cluster via ISupportedPriceInfo, DOM history support, Export throttling\n" +
                        $"{new string('=', 80)}\n\n");
                }
            }
            catch (Exception ex)
        ...
        private void ProcessBar(int bar)
        {
            ...
            var rec = new
            {
                header = new
                {
                    ...
                    version = "mif.v18.0",
                    exporter = "MIF.AtasIndicator.V18",
        ...
        protected override void OnDispose()
        {
            ...
            try
            {
                ...
                {
                    File.AppendAllText(_alivePath,
                        $"\n[V18-BACKTRACK] Starting full history scan from bar 0 to {CurrentBar - 1}...\n");
                }
                ...
                {
                    File.AppendAllText(_alivePath,
                        $"[V18-BACKTRACK] Completed. Recovered {backtrackCount} missing bars.\n\n");
                }
            }
            catch (Exception ex)
            {
